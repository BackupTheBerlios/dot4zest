...
/** Zest graph generated from Graphviz DOT graph 'LayoutSpringGraph'. */
public class LayoutSpringGraph extends Graph {
	public LayoutSpringGraph(final Composite parent, final int style) {
		super(parent, style);
	...
	public static void main(final String[] args) {
		...
		String dot = new LayoutSpringGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(LayoutSpringGraph.class.getSimpleName());
	...
	public LayoutSpringGraph() { // for JUnit
