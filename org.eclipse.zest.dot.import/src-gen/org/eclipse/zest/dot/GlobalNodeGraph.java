...
/** Zest graph generated from Graphviz DOT graph 'GlobalNodeGraph'. */
public class GlobalNodeGraph extends Graph {
	public GlobalNodeGraph(final Composite parent, final int style) {
		super(parent, style);
		...
		GraphNode n3 = new GraphNode(this, SWT.NONE, "Leaf");
	...
	public static void main(final String[] args) {
		...
		String dot = new GlobalNodeGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(GlobalNodeGraph.class.getSimpleName());
	...
	public GlobalNodeGraph() { // for JUnit
