...
/** Zest graph generated from Graphviz DOT graph 'BasicDirectedGraph'. */
public class BasicDirectedGraph extends Graph {
	public BasicDirectedGraph(final Composite parent, final int style) {
		super(parent, style);
	...
	public static void main(final String[] args) {
		...
		String dot = new BasicDirectedGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(BasicDirectedGraph.class.getSimpleName());
