...
/** Zest graph generated from Graphviz DOT graph 'LayoutRadialGraph'. */
public class LayoutRadialGraph extends Graph {
	public LayoutRadialGraph(final Composite parent, final int style) {
		super(parent, style);
	...
	public static void main(final String[] args) {
		...
		String dot = new LayoutRadialGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(LayoutRadialGraph.class.getSimpleName());
	...
	public LayoutRadialGraph() { // for JUnit
