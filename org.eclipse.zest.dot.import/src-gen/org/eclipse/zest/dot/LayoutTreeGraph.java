...
/** Zest graph generated from Graphviz DOT graph 'LayoutTreeGraph'. */
public class LayoutTreeGraph extends Graph {
	public LayoutTreeGraph(final Composite parent, final int style) {
		super(parent, style);
	...
	public static void main(final String[] args) {
		...
		String dot = new LayoutTreeGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(LayoutTreeGraph.class.getSimpleName());
	...
	public LayoutTreeGraph() { // for JUnit
