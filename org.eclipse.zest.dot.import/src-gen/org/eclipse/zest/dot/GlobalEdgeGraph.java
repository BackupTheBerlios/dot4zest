...
/** Zest graph generated from Graphviz DOT graph 'GlobalEdgeGraph'. */
public class GlobalEdgeGraph extends Graph {
	public GlobalEdgeGraph(final Composite parent, final int style) {
		super(parent, style);
	...
	public static void main(final String[] args) {
		...
		String dot = new GlobalEdgeGraph(shell, SWT.NONE).toDot();
	...
	public GlobalEdgeGraph() { // for JUnit
