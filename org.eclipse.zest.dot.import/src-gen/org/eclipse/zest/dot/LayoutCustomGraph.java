...
/** Zest graph generated from Graphviz DOT graph 'LayoutCustomGraph'. */
public class LayoutCustomGraph extends Graph {
	public LayoutCustomGraph(final Composite parent, final int style) {
		super(parent, style);
		...
		setLayoutAlgorithm(new CustomLayoutAlgorithm(
	...
	public static void main(final String[] args) {
		...
		String dot = new LayoutCustomGraph(shell, SWT.NONE).toDot();
	...
	private static Shell createShell() {
		...
		shell.setText(LayoutCustomGraph.class.getSimpleName());
	...
	public LayoutCustomGraph() { // for JUnit
